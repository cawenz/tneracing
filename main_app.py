...
class RFIDTagMonitor:
    ...
    def setup_ui(self):
        ...
        self.standings_tree.heading("laps", text="Total Laps")
        self.standings_tree.heading("gap", text="Gap")
        self.standings_tree.heading("best_lap_time", text="Best Lap")
        self.standings_tree.heading("last_lap_time", text="Last Lap")
        self.standings_tree.heading("total_time", text="Time")
